...
public class WordSearch : MonoBehaviour {
	...
	public void endLevel(){
		//open the next level
		if(PlayerPrefs.GetInt(category + "Word Search Level") != categories[category].wordPuzzles.Count - 1){
